...
ggsave("../09_Figures/logit_age_pre_reg.png",  dpi = 300, 
...
ggsave("../09_Figures/logit_edu_pre_reg.png",  dpi = 300, 
       width = 8, height = 6, units = "in")
```
...
ggsave("../09_Figures/logit_age_new_exclude.png",  dpi = 300, 
       width = 8, height = 6, units = "in")
...
ggsave("../09_Figures/logit_edu_new_exclude.png",  dpi = 300, 
       width = 8, height = 6, units = "in")
```
...
ggsave("../09_Figures/turk_know_cond.png",  dpi = 300, 
       width = 8, height = 6, units = "in")
...
ggsave("../09_Figures/turk_know.png",  dpi = 300, 
       width = 8, height = 6, units = "in")
```
...
ggsave("../09_Figures/turk_know_vas.png",  dpi = 300, 
       width = 8, height = 6, units = "in")
```
...
ggsave("../09_Figures/turk_reason_vas.png",  dpi = 300, 
       width = 8, height = 6, units = "in")
```
...
ggsave("../09_Figures/continuous_country.png", dpi = 300)
...
ggsave("../09_Figures/binned_country.png", bin_country, dpi = 300)
...
ggsave("../09_Figures/forest_country_gi.png",  dpi = 300, 
       width = 8, height = 6, units = "in")
...
ggsave("../09_Figures/forest_country_GK.png",  dpi = 300, 
       width = 8, height = 6, units = "in")
