...
In this section, we clean up the following data issues:
  ...
  - Fixed lab IDs that were duplicated (i.e., original ID was coded in two different ways)

```{r}
# fixed lab IDs
full_long$lab_id[full_long$lab_id == "086a2b"] <- "905904"

full_long$lab_id[full_long$lab_id == "cabbe9"] <- "c1e6b4"
full_long$lab_id[full_long$lab_id == "d47b47"] <- "c1e6b4"
...
# remove this test lab code 
full_long <- subset(full_long, lab_id != "9bdc87")
...
table(final_long$lab_id, final_long$education)
...
```{r}
model.4 <- glmer(reason_vas_combined ~ (1|vignette/id/lab_id),
                      data = final_long,
                      family = binomial,
                      control = glmerControl(optimizer = "bobyqa"),
                      nAGQ = 0)
...
```{r}
model.5 <- glmer(reason_vas_combined ~ (1|vignette/id/lab_id) + 
                   comp + age + gender2 + education,
                      data = final_long,
                      family = binomial,
                      control = glmerControl(optimizer = "bobyqa"),
...
```{r}
model.6 <- glmer(reason_vas_combined ~ (1|vignette/id/lab_id) + 
                   comp + age + gender2 + education + 
                   cond,
                      data = final_long,
                      family = binomial,
...
```{r}
model.6A <- glmer(reason_vas_combined ~ (1 | vignette/id/lab_id) + 
                   comp + age + gender2 + education + 
                   cond*vignette,
                      data = final_long,
                      family = binomial,
...
```{r}
model.6B <- glmer(reason_vas_combined ~ (1|vignette/id/lab_id) + 
                    comp + age + gender2 + education + 
                    cond*turk,
                      data = final_long,
                      family = binomial,
...
```{r}
model.6C <- glmer(reason_vas_combined ~ (1|vignette/id/lab_id) + 
                    comp + age + gender2 + education + 
...
```{r}
model.4 <- glmer(luck_vas_combined ~ (1|vignette/id/lab_id),
                      data = final_long,
                      family = binomial,
                      control = glmerControl(optimizer = "bobyqa"),
                      nAGQ = 0)
...
```{r}
model.5 <- glmer(luck_vas_combined ~ (1|vignette/id/lab_id) + 
                   comp + age + gender2 + education,
                      data = final_long,
                      family = binomial,
                      control = glmerControl(optimizer = "bobyqa"),
...
```{r}
model.6 <- glmer(luck_vas_combined ~ (1|vignette/id/lab_id) + 
                   comp + age + gender2 + education + 
                   cond,
                      data = final_long,
                      family = binomial,
...
```
  ...
  - In Knoweledge, people are more likely to chose ability. 
...
```{r}
model.6A <- glmer(luck_vas_combined ~ (1 | vignette/id/lab_id) + 
                   comp + age + gender2 + education + 
                   cond*vignette,
                      data = final_long,
                      family = binomial,
...
- No differences in Gettier and Ignorance 
- More likely to pick ability in Knowledge than Gettier 
...
```{r}
model.6B <- glmer(luck_vas_combined ~ (1|vignette/id/lab_id) + 
                    comp + age + gender2 + education + 
                    cond*turk,
                      data = final_long,
                      family = binomial,
...
```{r}
model.6C <- glmer(luck_vas_combined ~ (1|vignette/id/lab_id) + 
                    comp + age + gender2 + education + 
