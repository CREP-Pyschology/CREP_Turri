...
# prop tests
prop1 <- prop.test(t(k.d_table[1:2, 1:2]))
prop1
v.chi.sq(x2 = prop1$statistic, 
         n = sum(t(k.d_table[1:2, 1:2])),
         r = 2, c = 2)

prop2 <- prop.test(t(k.d_table[1:2, c(1,3)]))
prop2
...
# prop tests
prop1 <- prop.test(t(k.e_table[1:2, 1:2]))
prop1
v.chi.sq(x2 = prop1$statistic, 
         n = sum(t(k.e_table[1:2, 1:2])),
         r = 2, c = 2)

prop2 <- prop.test(t(k.e_table[1:2, c(1,3)]))
prop2
v.chi.sq(x2 = prop2$statistic, 
...
# prop tests
prop1 <- prop.test(t(k.g_table[1:2, 1:2]))
prop1
v.chi.sq(x2 = prop1$statistic, 
         n = sum(t(k.g_table[1:2, 1:2])),
         r = 2, c = 2)

prop2 <- prop.test(t(k.g_table[1:2, c(1,3)]))
prop2
v.chi.sq(x2 = prop2$statistic, 
         n = sum(t(k.g_table[1:2, c(1,3)])),
         r = 2, c = 2)
```
...
# prop tests
prop1 <- prop.test(t(r.d_table[1:2, 1:2]))
prop1
v.chi.sq(x2 = prop1$statistic, 
         n = sum(t(r.d_table[1:2, 1:2])),
         r = 2, c = 2)

prop2 <- prop.test(t(r.d_table[1:2, c(1,3)]))
prop2
v.chi.sq(x2 = prop2$statistic, 
...
# prop tests
prop1 <- prop.test(t(r.e_table[1:2, 1:2]))
prop1
v.chi.sq(x2 = prop1$statistic, 
         n = sum(t(r.e_table[1:2, 1:2])),
         r = 2, c = 2)

prop2 <- prop.test(t(r.e_table[1:2, c(1,3)]))
prop2
v.chi.sq(x2 = prop2$statistic, 
...
# prop tests
prop1 <- prop.test(t(r.g_table[1:2, 1:2]))
prop1
v.chi.sq(x2 = prop1$statistic, 
         n = sum(t(r.g_table[1:2, 1:2])),
         r = 2, c = 2)

prop2 <- prop.test(t(r.g_table[1:2, c(1,3)]))
prop2
v.chi.sq(x2 = prop2$statistic, 
...
# percent correct
table(full_long$darrel_exclusion[!duplicated(full_long$id)]) / length(unique(full_long$id))
