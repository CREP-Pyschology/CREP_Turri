...
table(final_long$know_vas_combined_source)
...
table(final_luck$luck_vas_combined)
table(final_luck$luck_vas_combined_source)
```
...
table(final_long$person_code, final_long$education)
...
```
  ...
  - Coefficients:
    ...
    - Education is a negative coefficient indicating that the less educate a person_code listed, the more likely they were to pick reasonable. 
