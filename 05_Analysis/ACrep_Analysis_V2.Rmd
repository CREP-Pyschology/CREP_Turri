...
full_long$lab_id <- as.character(full_long$lab_id)
full_long$lab_id[full_long$lab_id == "855e89"] <- "8.55E+91"
full_long$lab_id[full_long$lab_id == "053396"] <- "53396"
...
darrel_exclude <- full_long$id[full_long$vignette == "Darrel" & 
                                 full_long$compr == 2]
