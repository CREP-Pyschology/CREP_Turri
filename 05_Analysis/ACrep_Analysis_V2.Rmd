...
```{r}
model.4 <- glmer(know_vas_combined ~ (1|vignette/id/Person),
                      data = final_long,
                      family = binomial,
                      control = glmerControl(optimizer = "bobyqa"),
                      nAGQ = 0)
...
```{r}
model.5 <- glmer(know_vas_combined ~ (1|vignette/id/Person) + 
...
```{r}
model.6 <- glmer(know_vas_combined ~ (1|vignette/id/Person) + 
                   comp + age + gender2 + education + 
                   cond,
                      data = final_long,
                      family = binomial,
...
```{r}
model.6A <- glmer(know_vas_combined ~ (1 | vignette/id/Person) + 
                   comp + age + gender2 + education + 
                   cond*vignette,
                      data = final_long,
                      family = binomial,
...
```{r}
model.6B <- glmer(know_vas_combined ~ (1|vignette/id/Person) + 
                    comp + age + gender2 + education + 
                    cond*turk,
                      data = final_long,
                      family = binomial,
...
```{r}
model.6C <- glmer(know_vas_combined ~ (1|vignette/id/Person) + 
                    comp + age + gender2 + education + 
...
model.1 <- glm(reason_vas_combined ~ 1,
               data = final_long,
               family = binomial,
               na.action = "na.omit")
...
```{r}
model.2 <- glmer(reason_vas_combined ~ (1|vignette),
                      data = final_long,
                      family = binomial,
                      control = glmerControl(optimizer = "bobyqa"),
                      nAGQ = 0)
...
```{r}
model.3 <- glmer(reason_vas_combined ~ (1|vignette/id),
                      data = final_long,
                      family = binomial,
                      control = glmerControl(optimizer = "bobyqa"),
                      nAGQ = 0)
...
```{r}
model.4 <- glmer(reason_vas_combined ~ (1|vignette/id/Person),
                      data = final_long,
                      family = binomial,
                      control = glmerControl(optimizer = "bobyqa"),
                      nAGQ = 0)
...
```{r}
model.5 <- glmer(reason_vas_combined ~ (1|vignette/id/Person) + 
                   comp + age + gender2 + education,
                      data = final_long,
                      family = binomial,
                      control = glmerControl(optimizer = "bobyqa"),
...
table(model.5@frame$comp, model.5@frame$reason_vas_combined)
...
```{r}
model.6 <- glmer(reason_vas_combined ~ (1|vignette/id/Person) + 
                   comp + age + gender2 + education + 
                   cond,
                      data = final_long,
                      family = binomial,
...
table(model.6@frame$cond, model.6@frame$reason_vas_combined)
...
```{r}
model.6A <- glmer(reason_vas_combined ~ (1 | vignette/id/Person) + 
                   comp + age + gender2 + education + 
                   cond*vignette,
                      data = final_long,
                      family = binomial,
...
```{r}
# overall darrel
chisq.test(data_graph$reason_vas_combined[data_graph$vignette == "Darrel"], 
           data_graph$cond[data_graph$vignette == "Darrel"])
d_table <- table(data_graph$reason_vas_combined[data_graph$vignette == "Darrel"], 
           data_graph$cond[data_graph$vignette == "Darrel"])
d_table
...
```{r}
# overall emma
chisq.test(data_graph$reason_vas_combined[data_graph$vignette == "Emma"], 
           data_graph$cond[data_graph$vignette == "Emma"])
e_table <- table(data_graph$reason_vas_combined[data_graph$vignette == "Emma"], 
           data_graph$cond[data_graph$vignette == "Emma"])
e_table
...
```{r}
# overall gerald
chisq.test(data_graph$reason_vas_combined[data_graph$vignette == "Gerald"], 
           data_graph$cond[data_graph$vignette == "Gerald"])
g_table <- table(data_graph$reason_vas_combined[data_graph$vignette == "Gerald"], 
           data_graph$cond[data_graph$vignette == "Gerald"])
g_table
...
```{r}
model.6B <- glmer(reason_vas_combined ~ (1|vignette/id/Person) + 
                    comp + age + gender2 + education + 
                    cond*turk,
                      data = final_long,
                      family = binomial,
...
```{r}
model.6C <- glmer(reason_vas_combined ~ (1|vignette/id/Person) + 
                    comp + age + gender2 + education + 
...
model.1 <- glm(luck_vas_combined ~ 1,
               data = final_long,
               family = binomial,
               na.action = "na.omit")
...
```{r}
model.2 <- glmer(luck_vas_combined ~ (1|vignette),
                      data = final_long,
                      family = binomial,
                      control = glmerControl(optimizer = "bobyqa"),
                      nAGQ = 0)
...
```{r}
model.3 <- glmer(luck_vas_combined ~ (1|vignette/id),
                      data = final_long,
                      family = binomial,
                      control = glmerControl(optimizer = "bobyqa"),
                      nAGQ = 0)
...
```{r}
model.4 <- glmer(luck_vas_combined ~ (1|vignette/id/Person),
                      data = final_long,
                      family = binomial,
                      control = glmerControl(optimizer = "bobyqa"),
                      nAGQ = 0)
...
```{r}
model.5 <- glmer(luck_vas_combined ~ (1|vignette/id/Person) + 
                   comp + age + gender2 + education,
                      data = final_long,
                      family = binomial,
                      control = glmerControl(optimizer = "bobyqa"),
...
table(model.5@frame$luck_vas_combined, model.5@frame$comp)
...
```
  ...
  - Coeffients:
    ...
    - **Compensation**: Yes group slightly more likely to say luck. **Check again after comp questions answered**
...
```{r}
model.6 <- glmer(luck_vas_combined ~ (1|vignette/id/Person) + 
                   comp + age + gender2 + education + 
                   cond,
                      data = final_long,
                      family = binomial,
...
table(model.6@frame$cond, model.6@frame$luck_vas_combined)
...
data_graph <- model.6A@frame
data_graph$luck_vas_combined <- factor(data_graph$luck_vas_combined,
                                          levels = c(0,1),
...
```{r}
# overall darrel
chisq.test(data_graph$luck_vas_combined[data_graph$vignette == "Darrel"], 
           data_graph$cond[data_graph$vignette == "Darrel"])
d_table <- table(data_graph$luck_vas_combined[data_graph$vignette == "Darrel"], 
           data_graph$cond[data_graph$vignette == "Darrel"])
d_table
...
```{r}
# overall emma
chisq.test(data_graph$luck_vas_combined[data_graph$vignette == "Emma"], 
           data_graph$cond[data_graph$vignette == "Emma"])
e_table <- table(data_graph$luck_vas_combined[data_graph$vignette == "Emma"], 
           data_graph$cond[data_graph$vignette == "Emma"])
e_table
...
```{r}
# overall gerald
chisq.test(data_graph$luck_vas_combined[data_graph$vignette == "Gerald"], 
           data_graph$cond[data_graph$vignette == "Gerald"])
g_table <- table(data_graph$luck_vas_combined[data_graph$vignette == "Gerald"], 
           data_graph$cond[data_graph$vignette == "Gerald"])
g_table
...
```{r}
model.6B <- glmer(luck_vas_combined ~ (1|vignette/id/Person) + 
                    comp + age + gender2 + education + 
                    cond*turk,
                      data = final_long,
                      family = binomial,
...
```{r}
model.6C <- glmer(luck_vas_combined ~ (1|vignette/id/Person) + 
                    comp + age + gender2 + education + 
...
table(model.6C@frame$luck_vas_combined, model.6C@frame$cond, model.6C@frame$luck_vas_combined_source)

r.squaredGLMM(model.6C)

data_graph <- model.6C@frame
data_graph$luck_vas_combined <- factor(data_graph$luck_vas_combined,
                                          levels = c(0,1),
                                          labels = c("Luck", "Ability"))
...
```{r}
# overall binary
chisq.test(data_graph$luck_vas_combined[data_graph$luck_vas_combined_source == "Binary"],
           data_graph$cond[data_graph$luck_vas_combined_source == "Binary"])

b_table <- table(data_graph$luck_vas_combined[data_graph$luck_vas_combined_source == "Binary"],
           data_graph$cond[data_graph$luck_vas_combined_source == "Binary"])
...
```{r}
# overall VAS
chisq.test(data_graph$luck_vas_combined[data_graph$luck_vas_combined_source == "VAS"],
           data_graph$cond[data_graph$luck_vas_combined_source == "VAS"])

v_table <- table(data_graph$luck_vas_combined[data_graph$luck_vas_combined_source == "VAS"],
           data_graph$cond[data_graph$luck_vas_combined_source == "VAS"])
...
```{r}
model.6D <- glmer(know_vas_combined ~ (1|vignette/id/Person) + 
                    comp + age + gender2 + education + 
                    cond*reason_vas_combined,
                      data = final_long,
                      family = binomial,
                      control = glmerControl(optimizer = "bobyqa"),
                      nAGQ = 0)
...
r.squaredGLMM(model.6D)

data_graph <- model.6D@frame
data_graph$know_vas_combined <- factor(data_graph$know_vas_combined, 
                                       levels = 0:1,
...
table(data_graph$know_vas_combined, data_graph$cond, data_graph$reason_vas_combined)

#graph the three way binary 
ggplot(data_graph) +
  geom_mosaic(aes(x = product(know_vas_combined, cond, reason_vas_combined), 
                  fill = know_vas_combined)) + 
...
```
  ...
  - Model 6 AIC: `r AIC(model.6)`
  - Model 6D AIC: `r AIC(model.6D)`
  - Interpretation: This model is better than the original model without the interaction.
  - There is an interaction between condition, reasoning choice to predict knowledge. 
  
```{r}
# break down by reasonable and unreasonable 

# reasonable
r_table <- table(data_graph$know_vas_combined[data_graph$reason_vas_combined == "Reasonable"], data_graph$cond[data_graph$reason_vas_combined == "Reasonable"])
chisq.test(data_graph$know_vas_combined[data_graph$reason_vas_combined == "Reasonable"], data_graph$cond[data_graph$reason_vas_combined == "Reasonable"])

# prop tests
prop1 <- prop.test(t(r_table[1:2, 1:2]))
prop1
v.chi.sq(x2 = prop1$statistic, 
         n = sum(t(r_table[1:2, 1:2])),
         r = 2, c = 2)

prop2 <- prop.test(t(r_table[1:2, c(1,3)]))
prop2
v.chi.sq(x2 = prop2$statistic, 
         n = sum(t(r_table[1:2, c(1,3)])),
         r = 2, c = 2)

# unreasonable
u_table <- table(data_graph$know_vas_combined[data_graph$reason_vas_combined == "Unreasonable"], data_graph$cond[data_graph$reason_vas_combined == "Unreasonable"])
chisq.test(data_graph$know_vas_combined[data_graph$reason_vas_combined == "Unreasonable"], data_graph$cond[data_graph$reason_vas_combined == "Unreasonable"])

# prop tests
prop1 <- prop.test(t(u_table[1:2, 1:2]))
prop1
v.chi.sq(x2 = prop1$statistic, 
         n = sum(t(u_table[1:2, 1:2])),
         r = 2, c = 2)

prop2 <- prop.test(t(u_table[1:2, c(1,3)]))
prop2
v.chi.sq(x2 = prop2$statistic, 
         n = sum(t(u_table[1:2, c(1,3)])),
         r = 2, c = 2)
```

- When we pick reasonable:
  - Gettier more likely to pick knows than Ignorance
  - Knowledge more likely to pick knows than Gettier
- When we pick unreasonable:
  - Gettier more likely to pick knows than Ignorance
  - Knowledge and Gettier do not support differences 

### Condition by Luck 

```{r}
model.6E <- glmer(know_vas_combined ~ (1|vignette/id/Person) + 
                    comp + age + gender2 + education + 
...
r.squaredGLMM(model.6E)

data_graph <- model.6E@frame
data_graph$know_vas_combined <- factor(data_graph$know_vas_combined, 
                                       levels = 0:1,
                                       labels = c("Know", "Believes"))
data_graph$luck_vas_combined <- factor(data_graph$luck_vas_combined, 
...
table(data_graph$know_vas_combined, data_graph$cond, data_graph$luck_vas_combined)
...
# luck
l_table <- table(data_graph$know_vas_combined[data_graph$luck_vas_combined == "Luck"], data_graph$cond[data_graph$luck_vas_combined == "Luck"])
chisq.test(data_graph$know_vas_combined[data_graph$luck_vas_combined == "Luck"], data_graph$cond[data_graph$luck_vas_combined == "Luck"])
...
# ability
a_table <- table(data_graph$know_vas_combined[data_graph$luck_vas_combined == "Ability"], data_graph$cond[data_graph$luck_vas_combined == "Ability"])
chisq.test(data_graph$know_vas_combined[data_graph$luck_vas_combined == "Ability"], data_graph$cond[data_graph$luck_vas_combined == "Ability"])
...
model.6F <- glmer(know_alt ~ (1|vignette/id/Person) + 
                   comp + age + gender2 + education + 
                   cond,
                      data = final_long,
                      family = binomial,
...
```{r}
model.6G <- glmer(know_vas_combined ~ (1|vignette/id/Person) + 
                   comp + age + gender2 + education + 
...
r.squaredGLMM(model.6G)
```

  - Model 6 AIC: `r AIC(model.6)`
  - Model 6F AIC: `r AIC(model.6G)`
...
```{r}
model.6H <- glmer(know_vas_combined ~ (1|vignette/id/Person) + 
                   comp + age + gender2 + education + 
...
r.squaredGLMM(model.6H)
```

  - Model 6 AIC: `r AIC(model.6G)`
  - Model 6F AIC: `r AIC(model.6H)`
