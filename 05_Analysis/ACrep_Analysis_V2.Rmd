...
# prop tests
prop1 <- prop.test(t(k.d_table[2:1, 2:1]))
prop1
v.chi.sq(x2 = prop1$statistic, 
         n = sum(t(k.d_table[2:1, 2:1])),
         r = 2, c = 2)

prop2 <- prop.test(t(k.d_table[2:1, c(3,1)]))
prop2
...
# prop tests
prop1 <- prop.test(t(k.e_table[2:1, 2:1]))
prop1
v.chi.sq(x2 = prop1$statistic, 
         n = sum(t(k.e_table[2:1, 2:1])),
         r = 2, c = 2)

prop2 <- prop.test(t(k.e_table[2:1, c(3,1)]))
prop2
v.chi.sq(x2 = prop2$statistic, 
...
# prop tests
prop1 <- prop.test(t(k.g_table[2:1, 2:1]))
prop1
v.chi.sq(x2 = prop1$statistic, 
         n = sum(t(k.g_table[2:1, 2:1])),
         r = 2, c = 2)

prop2 <- prop.test(t(k.g_table[2:1, c(3,1)]))
prop2
v.chi.sq(x2 = prop2$statistic, 
...
# prop tests
prop1 <- prop.test(t(r.d_table[2:1, 2:1]))
prop1
v.chi.sq(x2 = prop1$statistic, 
         n = sum(t(r.d_table[2:1, 2:1])),
         r = 2, c = 2)

prop2 <- prop.test(t(r.d_table[2:1, c(3,1)]))
prop2
v.chi.sq(x2 = prop2$statistic, 
...
# prop tests
prop1 <- prop.test(t(r.e_table[2:1, 2:1]))
prop1
v.chi.sq(x2 = prop1$statistic, 
         n = sum(t(r.e_table[2:1, 2:1])),
         r = 2, c = 2)

prop2 <- prop.test(t(r.e_table[2:1, c(3,1)]))
prop2
v.chi.sq(x2 = prop2$statistic, 
...
# prop tests
prop1 <- prop.test(t(r.g_table[2:1, 2:1]))
prop1
v.chi.sq(x2 = prop1$statistic, 
         n = sum(t(r.g_table[2:1, 2:1])),
         r = 2, c = 2)

prop2 <- prop.test(t(r.g_table[2:1, c(3,1)]))
prop2
v.chi.sq(x2 = prop2$statistic, 
...
# prop tests
prop1 <- prop.test(t(l_table[2:1, 2:1]))
prop1
v.chi.sq(x2 = prop1$statistic, 
         n = sum(t(l_table[2:1, 2:1])),
         r = 2, c = 2)

prop2 <- prop.test(t(l_table[2:1, c(3,1)]))
prop2
v.chi.sq(x2 = prop2$statistic, 
         n = sum(t(l_table[2:1, c(3,1)])),
         r = 2, c = 2)
...
# prop tests
prop1 <- prop.test(t(a_table[2:1, 2:1]))
prop1
v.chi.sq(x2 = prop1$statistic, 
         n = sum(t(a_table[2:1, 2:1])),
         r = 2, c = 2)

prop2 <- prop.test(t(a_table[2:1, c(3,1)]))
prop2
v.chi.sq(x2 = prop2$statistic, 
         n = sum(t(a_table[2:1, c(3,1)])),
         r = 2, c = 2)
```
