...
ggsave("../09_Figures/manu_fig_2.png",  dpi = 300, 
...
k.model.6@frame %>% 
  ...
  ungroup() %>% 
  rbind(., c("$\\chi^2$", 
            paste("(1) = ", round(k.chance.k$statistic, digits = 2), ", *p* < .001", sep = ""), 
            paste("(1) = ", round(k.chance.i$statistic, digits = 2), ", *p* < .001", sep = ""), 
            paste("(1) = ", round(k.chance.g$statistic, digits = 2), ", *p* < .001", sep = ""))) %>% 
...
k.dcond_GI <- prop.test(t(k.d_table[2:1, 1:2])) %>% 
  tidy()

k.dcond_GI_v <- v.chi.sq(x2 = prop.test(t(k.d_table[2:1, 1:2]))$statistic, 
         n = sum(t(k.d_table[2:1, 1:2])),
         r = 2, c = 2) 

k.dcond_GK <- prop.test(t(k.d_table[2:1, c(1,3)])) %>% 
  tidy()

k.dcond_GK_v <- v.chi.sq(x2 = prop.test(t(k.d_table[2:1, c(1,3)]))$statistic, 
...
k.econd_GI <- prop.test(t(k.e_table[2:1, 1:2])) %>% 
  tidy()

k.econd_GI_v <- v.chi.sq(x2 = prop.test(t(k.e_table[2:1, 1:2]))$statistic, 
         n = sum(t(k.e_table[2:1, 1:2])),
         r = 2, c = 2) 

k.econd_GK <- prop.test(t(k.e_table[2:1, c(1,3)])) %>% 
  tidy()

k.econd_GK_v <- v.chi.sq(x2 = prop.test(t(k.e_table[2:1, c(1,3)]))$statistic, 
...
k.gcond_GI <- prop.test(t(k.g_table[2:1, 1:2])) %>% 
  tidy()

k.gcond_GI_v <- v.chi.sq(x2 = prop.test(t(k.g_table[2:1, 1:2]))$statistic, 
         n = sum(t(k.g_table[2:1, 1:2])),
         r = 2, c = 2) 

k.gcond_GK <- prop.test(t(k.g_table[2:1, c(1,3)])) %>% 
  tidy()

k.gcond_GK_v <- v.chi.sq(x2 = prop.test(t(k.g_table[2:1, c(1,3)]))$statistic, 
...
ggsave("../09_Figures/manu_fig_3.png",  dpi = 300, 
       width = 8, height = 6, units = "in")
...
ggsave("../09_Figures/manu_fig_3b.png",  dpi = 300, 
       width = 8, height = 6, units = "in")
...
ggsave("../09_Figures/manu_fig_4.png",  dpi = 300, 
       width = 8, height = 6, units = "in")
...
ggsave("../09_Figures/manu_fig_4b.png",  dpi = 300, 
       width = 8, height = 6, units = "in")
```
...
r.dcond_GI <- prop.test(t(r.d_table[2:1, 1:2])) %>% 
  tidy()

r.dcond_GI_v <- v.chi.sq(x2 = prop.test(t(r.d_table[2:1, 1:2]))$statistic, 
         n = sum(t(r.d_table[2:1, 1:2])),
         r = 2, c = 2) 

r.dcond_GK <- prop.test(t(r.d_table[2:1, c(1,3)])) %>% 
  tidy()

r.dcond_GK_v <- v.chi.sq(x2 = prop.test(t(r.d_table[2:1, c(1,3)]))$statistic, 
...
r.econd_GI <- prop.test(t(r.e_table[2:1, 1:2])) %>% 
  tidy()

r.econd_GI_v <- v.chi.sq(x2 = prop.test(t(r.e_table[2:1, 1:2]))$statistic, 
         n = sum(t(r.e_table[2:1, 1:2])),
         r = 2, c = 2) 

r.econd_GK <- prop.test(t(r.e_table[2:1, c(1,3)])) %>% 
  tidy()

r.econd_GK_v <- v.chi.sq(x2 = prop.test(t(r.e_table[2:1, c(1,3)]))$statistic, 
...
r.gcond_GI <- prop.test(t(r.g_table[2:1, 1:2])) %>% 
  tidy()

r.gcond_GI_v <- v.chi.sq(x2 = prop.test(t(r.g_table[2:1, 1:2]))$statistic, 
         n = sum(t(r.g_table[2:1, 1:2])),
         r = 2, c = 2) 

r.gcond_GK <- prop.test(t(r.g_table[2:1, c(1,3)])) %>% 
  tidy()

r.gcond_GK_v <- v.chi.sq(x2 = prop.test(t(r.g_table[2:1, c(1,3)]))$statistic, 
...
k.dcond_GI_rep <- prop.test(t(k.d_table_rep[2:1, 1:2])) %>% 
  tidy()

k.dcond_GI_v_rep <- v.chi.sq(x2 = prop.test(t(k.d_table_rep[2:1, 1:2]))$statistic, 
         n = sum(t(k.d_table_rep[2:1, 1:2])),
         r = 2, c = 2) 

k.dcond_GK_rep <- prop.test(t(k.d_table_rep[2:1, c(1,3)])) %>% 
  tidy()

k.dcond_GK_v_rep <- v.chi.sq(x2 = prop.test(t(k.d_table_rep[2:1, c(1,3)]))$statistic, 
         n = sum(t(k.d_table_rep[2:1, c(1,3)])),
         r = 2, c = 2) 
```
...
ggsave("../09_Figures/manu_fig_5.png",  dpi = 300, 
       width = 8, height = 6, units = "in")
...
ggsave("../09_Figures/manu_fig_5b.png",  dpi = 300, 
       width = 8, height = 6, units = "in")
```
...
vas_cond_GI <- prop.test(t(vas_table[2:1, 1:2])) %>% 
  tidy()

vas_cond_GI_v <- v.chi.sq(x2 = prop.test(t(vas_table[2:1, 1:2]))$statistic, 
         n = sum(t(vas_table[2:1, 1:2])),
         r = 2, c = 2) 

vas_cond_GK<- prop.test(t(vas_table[2:1, c(1,3)])) %>% 
  tidy()

vas_cond_GK_v <- v.chi.sq(x2 = prop.test(t(vas_table[2:1, c(1,3)]))$statistic, 
         n = sum(t(vas_table[2:1, c(1,3)])),
         r = 2, c = 2)
```
...
ggsave("../09_Figures/manu_grid_1.png", dpi = 300, width = 8, height = 6, units = "in")
```
...
luck_interaction_cond_GI <-  prop.test(t(luck_interaction_table[2:1, 1:2])) %>% tidy()

luck_interaction_cond_GI_v <- v.chi.sq(x2 =  prop.test(t(luck_interaction_table[2:1, 1:2]))$statistic, 
         n = sum(t(luck_interaction_table[2:1, 1:2])),
         r = 2, c = 2)


luck_interaction_cond_GK <-  prop.test(t(luck_interaction_table[2:1, c(1,3)])) %>% tidy()

luck_interaction_cond_GK_v <- v.chi.sq(x2 = prop.test(t(luck_interaction_table[2:1, c(1,3)]))$statistic, 
         n = sum(t(luck_interaction_table[2:1, c(1,3)])),
         r = 2, c = 2)
...
ability_interaction_cond_GI <-   prop.test(t(ability_interaction_table[2:1, 1:2])) %>% tidy()

ability_interaction_cond_GI_v <- v.chi.sq(x2 = prop.test(t(ability_interaction_table[2:1, 1:2]))$statistic, 
         n = sum(t(ability_interaction_table[2:1, 1:2])),
         r = 2, c = 2)


ability_interaction_cond_GK <-  prop.test(t(ability_interaction_table [2:1, c(1,3)])) %>% tidy()

ability_interaction_cond_GK_v <- v.chi.sq(x2 =  prop.test(t(ability_interaction_table[2:1, c(1,3)]))$statistic, 
         n = sum(t(ability_interaction_table[2:1, c(1,3)])),
         r = 2, c = 2)
...
table(k.model.6F@frame$cond, k.model.6F@frame$know_alt) %>% 
  kable(caption = "Alternative Knowledge Probe", col.names = c("Feels they know, but doesn't know", "Knows")) %>% 
  kable_styling()
```
...
ggsave("../09_Figures/manu_fig_6.png",  dpi = 300, 
       width = 8, height = 6, units = "in")
```
