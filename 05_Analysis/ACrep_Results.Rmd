...
left_join(teams_per_site, full_data_n_per_site, by = "Person") %>% 
  ...
  distinct() %>% 
  left_join(select(lab_sheet, Person, Compensation), by = "Person") %>% 
  distinct()
