...
In the approved protocol, we described a plan for data collection whereby each lab pre-registered a target sample size of 50 and stopped collection data on April 1, 2020 or once all contributors reached their pre-registered target sample size. Due to the Covid-19 pandemic, this plan was not feasible. The deadline for data collection was extended to June 1, 2021. Many data collection sites stopped collecting data earlier.
