...
r.dcond_effect <- chisq.test(data_graph$know_vas_combined[data_graph$vignette == "Darrel"], 
           data_graph$cond[data_graph$vignette == "Darrel"]) %>% 
  tidy()
...
r.econd_effect <- chisq.test(r.data_graph$reason_vas_combined[r.data_graph$vignette == "Emma"], 
...
r.gcond_effect <- chisq.test(r.data_graph$reason_vas_combined[r.data_graph$vignette == "Gerald"], 
...
l.dcond_effect <- chisq.test(l.data_graph$luck_vas_combined[l.data_graph$vignette == "Darrel"], 
...
```{r Emma luck effect}
l.econd_effect <- chisq.test(l.data_graph$luck_vas_combined[l.data_graph$vignette == "Emma"], 
...
l.gcond_effect <- chisq.test(data_graph$know_vas_combined[data_graph$vignette == "Gerald"], 
           data_graph$cond[data_graph$vignette == "Gerald"]) %>% 
  tidy()
...
bin_cond <- chisq.test(l.data_graph$luck_vas_combined[l.data_graph$vignette == "Darrel"], 
           l.data_graph$cond[l.data_graph$vignette == "Darrel"])%>% 
  tidy() #this is broken for some reason
