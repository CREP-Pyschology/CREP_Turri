...
Vignette content varied by subject and identification target. There were three vignette scenarios that were randomly presented to participants: the "Squirrel/Darrel" vignette from Turri et al. (2015), the “Fake Barn/Gerald” vignette from Colaca et al. (2014; altered to include matched knowledge and ignorance control conditions), and the “Diamond/Emma” vignette from Nagel, San Juan, & Mar (2013). The vigenettes are reported in full in Appendix X. Vignettes were pretested for how effectively they manipulated the target construct and how much participants comprehended them (see Appendix B). Some labs tested an additional vignette that was not described in the approved protocol (for more information, see [LINK TO MORE INFORMATION]).
...
## Analysis Plan
  ...
  Multilevel models will be used to evaluate hypotheses. The unit of anlaysis will be the trial. Random intercepts for the vignette, participant, and data collection site will be included to account for the nesting of trials within these groups. 

## Power Anlaysis

  The approved protocol described power analyses that estimated the number of participants required to estimate an effect of knowledge condition on participants knowledge attributions at 90% power with an alpha of .05, and effect size estimates based on the pilot test and Experiment 1 of Turri et al. (2015) (see Appendix X for an updated version). [I honestly didn't follow the last paragraph on p 29 of the approved protocol relevant to this paragraph.]
