...
```{r}
#FIX -- Erin in the interpretation, you write that the interaction accounts for 7-9%... but I am not seeing where those numbres came from. 
```
...
Probing this interaction with chi-square analysis and proportion tests. With the Darrel vignette, people made different attributions in the different conditions X^2(2) = 482.47, p <.0001.

```{r}
k.d_table %>% 
  kable("Knowledge Attributions in the Darrel Vignette") %>% 
  kable_styling()
```
