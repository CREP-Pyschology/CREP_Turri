...
It is generally not recommended to transform continuous varibles in to discreet variables (cite). For the present analyses, however, splitting the continuously measured versions of these dependent variables such that scores at and below 40 and scores at and above 60 were classified into a discreet category allows us to validly fit models and also test whether the method of measurement (continous or binary) affects judgments. So, this was the approach taken.
